#!/usr/bin/env python3
"""Debug favorite POST response extraction."""

from api_extractor.extractors.java.spring_boot import SpringBootExtractor

extractor = SpringBootExtractor()

# Read and parse ArticleFavoriteApi.java
source_code = extractor._read_file("tests/fixtures/real-world/java/spring-boot/spring-boot-realworld-example-app/src/main/java/io/spring/api/ArticleFavoriteApi.java")
tree = extractor.parser.parse_source(source_code, "java")

# Find favoriteArticle method
method_query = """
(method_declaration
...
for match in matches:
    ...
    if method_name == "favoriteArticle":
        ...
        service_response = extractor._extract_service_method_response(
            method_decl_node,
            source_code,
            "tests/fixtures/real-world/java/spring-boot/spring-boot-realworld-example-app/src/main/java/io/spring/api/ArticleFavoriteApi.java"
        )
