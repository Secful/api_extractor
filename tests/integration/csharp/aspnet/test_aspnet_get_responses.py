"""Test GET endpoint response schema extraction for ASP.NET Core."""
...
@pytest.mark.skipif(
    ...
    reason="ASP.NET Core RealWorld app not cloned",
)
def test_get_endpoints_have_response_schemas():
    """Verify GET endpoints extract response schemas from ActionResult return types."""
