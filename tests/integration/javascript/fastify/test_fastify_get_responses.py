"""Test GET endpoint response schema extraction for Fastify."""
...
@pytest.mark.skipif(
    ...
    reason="Fastify boilerplate app not cloned",
)
def test_get_endpoints_have_response_schemas():
    """Verify GET endpoints extract response schemas from reply.send() calls."""
