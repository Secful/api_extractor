"""Test GET endpoint response schema extraction for Express."""
...
@pytest.mark.skipif(
    ...
    reason="Express RealWorld app not cloned",
)
def test_get_endpoints_have_response_schemas():
    """Verify GET endpoints extract response schemas from res.json() calls."""
